...
class CalendarData(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, default=1)  # Set the default user id here
    ...
    def __str__(self):
        return f"{self.user.username} - {self.day} - {self.from_time_formatted} to {self.to_time_formatted}"
